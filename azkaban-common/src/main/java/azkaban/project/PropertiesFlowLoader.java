...
class PropertiesFlowLoader implements FlowLoader {
  ...
  /**
   * Creates a new PropertiesFlowLoader.
   */
  public PropertiesFlowLoader(Props props, Logger logger) {
    this.logger = logger;
    this.props = props;
  ...
  private void jobPropertiesCheck(Project project) {
    ...
    String maxXms = props.getString(JobDefaults.JOB_MAX_XMS, JobDefaults.MAX_XMS_DEFAULT);
    String maxXmx = props.getString(JobDefaults.JOB_MAX_XMX, JobDefaults.MAX_XMX_DEFAULT);
